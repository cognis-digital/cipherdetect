"""CIPHERDETECT core — Detect & crack classical ciphers (caesar/vigenere/xor) by scoring."""
...
RULES = [
    ("CIP-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("CIP-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("CIP-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
