# Ports of cipherdetect

The same scan logic, ported across languages so you can drop cipherdetect into any stack
or ship a single static binary. All ports share the rule IDs and JSON output shape.

| Language | Path | Run |
|---|---|---|
| Python (reference) | `../cipherdetect/` | `cipherdetect scan .` |
