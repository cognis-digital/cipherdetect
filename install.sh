#!/usr/bin/env sh
# Universal installer for cipherdetect. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cipherdetect.git"
echo "Installing cipherdetect ..."
...
echo "Done. Run: cipherdetect --help"
