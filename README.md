...
[![PyPI](https://img.shields.io/pypi/v/cognis-cipherdetect.svg)](https://pypi.org/project/cognis-cipherdetect/)
[![CI](https://github.com/cognis-digital/cipherdetect/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/cipherdetect/actions)
...
CIPHERDETECT exists for one job — detect & crack classical ciphers (caesar/vigenere/xor) by scoring — and does it without a SaaS bill or heavyweight setup.
...
cipherdetect scan .                      # scan the current project
cipherdetect scan . --format json
cipherdetect scan . --fail-on high       # non-zero exit for CI gates
cipherdetect mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Ciphey**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`cipherdetect` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
